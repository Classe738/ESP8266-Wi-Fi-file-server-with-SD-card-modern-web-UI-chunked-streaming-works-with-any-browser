 ...
 * 
 * ![Breadboard prototype](docs/images/prototype_breadboard.jpg)
 ...
 * 
 * ![Soldering process](docs/images/soldering.jpg)
 ...
 * 
 * ![Final device in enclosure](docs/images/final_device.jpg)
 ...
 * 
 * ![Login screen](docs/images/ui_login.png)
 * *Login page with dark theme.*
 * 
 * ![File browser](docs/images/ui_files.png)
 * *Main file manager showing folders and files.*
 * 
 * ![Upload progress](docs/images/ui_upload.png)
